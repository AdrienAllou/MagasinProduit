 ...
 */
final class Version20201106133601 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, type_produit_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prix NUMERIC(8, 2) NOT NULL, photo VARCHAR(255) NOT NULL, disponible TINYINT(1) NOT NULL, date_lancement DATETIME NOT NULL, INDEX IDX_29A5EC271237A8DE (type_produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

...
{% block main %}
    <div style=\"width: 75%; margin: auto\">
        <form method=\"post\">
            ...
            {% if app.user %}
                <div class=\"mb-3\">
                    Vous êtes connecter en tant que : {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Deco</a>
                </div>
            {% endif %}
...
{% endblock %}
", "security/login.html.twig", "/home/userdepinfo/Documents/Belfort/S3/php/ProjetMagasinProduit/MagasinProduit/templates/security/login.html.twig");
    }
}

...
class __TwigTemplate_68a8f511fc8adae5b89e5a424e3bbf410d6fd8a44bbde3d8dd0472a1d5f43f8b extends Template
{
    private $source;
    private $macros = [];
...
{% block main %}
    {{ form_start(form) }}
        {{ form_rest(form) }}
    {{ form_end(form) }}
{% endblock %}", "security/inscription.html.twig", "C:\\Users\\seiak\\Documents\\cours_S3\\projet_bdd_adrien\\MagasinProduit\\templates\\security\\inscription.html.twig");
    }
}

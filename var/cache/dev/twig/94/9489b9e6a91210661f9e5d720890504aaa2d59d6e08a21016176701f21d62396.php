...
class __TwigTemplate_a58d4719244ed60dda9cb08422c5668ed94e50e3c0954e115cd879c4cbf8425e extends Template
{
    private $source;
    private $macros = [];
...
{% block main %}
    {{ form_start(form) }}
        {{ form_rest(form) }}
    {{ form_end(form) }}
{% endblock %}", "security/inscription.html.twig", "/home/userdepinfo/Documents/Belfort/S3/php/MagasinDeProduit/templates/security/inscription.html.twig");
    }
}
